...
namespace Infrastructure.Extensions
{
    public static class StringExtensions
    {
        ...
        public static string ReduceThreeDots(this string value, int length)
        {
        ...
        public static string GetMimeType(this string extension)
        {
            ...
            return _mimeTypeMappings.TryGetValue(extension, out mime) ? mime : "application/octet-stream";
        }
